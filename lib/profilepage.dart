              ...
              Row(
                children: [
                  Container(
                    height: height/13,
                    width: width/6.5,
                    decoration: BoxDecoration(shape: BoxShape.circle,image: DecorationImage(image: NetworkImage(widget.img),fit: BoxFit.contain)),
                  ),
                  SizedBox(width: width/30,),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Dinidu Prabhash",style: TextStyle(color: MyColors.darkblue,fontSize: width/16.3,fontWeight: FontWeight.bold),),
                      Row(
                        children: [
